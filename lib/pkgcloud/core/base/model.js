...
Model.prototype._setProperties = function (details) {
  var self = this;

  _.each(self._getAttributes(), function (value, key) {
    if (value instanceof Attribute) {
      self[key] = value.transform(details[value.key]) || value.defaultValue;
      return;
    }

    self[key] = details[value];
  });
};

Model.prototype.toJSON = function () {
  return _.pick(this, _.keys(this._getAttributes()));
};
